...
class AddCategoryWeightUseCase @Inject constructor(
    private val categoryWeightRepository: CategoryWeightRepository
) {
    suspend operator fun invoke(categoryWeight : CategoryWeight) = categoryWeightRepository.add(categoryWeight)
}